...
export default function Home() {
  console.log('PassShield Version: v2.5 - Client-Side TF.js Fix (8c73388)');
  ...
  return (
    <div className={`min-h-screen transition-all duration-500 ${isDark
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className={`absolute top-1/4 left-1/4 w-72 h-72 rounded-full opacity-20 blur-3xl ${isDark ? 'bg-purple-500' : 'bg-blue-400'
          } animate-pulse`} />
        <div className={`absolute top-3/4 right-1/4 w-96 h-96 rounded-full opacity-10 blur-3xl ${isDark ? 'bg-blue-500' : 'bg-purple-400'
          } animate-pulse`} style={{ animationDelay: '1s' }} />
        <div className={`absolute top-1/2 left-3/4 w-64 h-64 rounded-full opacity-15 blur-3xl ${isDark ? 'bg-cyan-500' : 'bg-indigo-400'
          ...
          <div className={`flex items-center justify-center gap-2 p-2 rounded-2xl backdrop-blur-md border transition-all ${isDark
            ...
            <button
              ...
              className={cn(
                ...
                activeTab === 'analyze'
                  ? `bg-gradient-to-r from-blue-500 to-purple-600 text-white shadow-lg ${isDark ? 'shadow-purple-500/25' : 'shadow-blue-500/25'
                  } transform scale-105`
                  : `${isDark
            ...
            <button
              ...
              className={cn(
                'flex items-center gap-3 px-6 py-3 rounded-xl transition-all duration-300 font-medium',
                activeTab === 'generate'
                  ? `bg-gradient-to-r from-purple-500 to-pink-600 text-white shadow-lg ${isDark ? 'shadow-purple-500/25' : 'shadow-purple-500/25'
                  } transform scale-105`
                  : `${isDark
                    ? 'text-gray-300 hover:text-white hover:bg-slate-700/50'
                    : 'text-gray-600 hover:text-gray-900 hover:bg-gray-100/50'
                    ...
                    <div className="flex-1 flex flex-col justify-center">
                      {analysis.dictionaryAnalysis.isInDictionary ? (
                        <div className="space-y-3">
                          <div className={`p-3 rounded-lg ${isDark ? 'bg-red-900/30 border border-red-700/50' : 'bg-red-50 border border-red-200'
                            }`}>
                        ...
                        <div className={`p-3 rounded-lg ${isDark ? 'bg-green-900/30 border border-green-700/50' : 'bg-green-50 border border-green-200'
                          }`}>
      ...
      {/* Footer */}
      <footer className={`relative mt-24 py-16 border-t transition-all ${isDark ? 'border-slate-700/50 bg-slate-900/50' : 'border-gray-200/50 bg-gray-50/50'
        } backdrop-blur-md`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
          ...
          >
            ...
            <div className={`flex flex-wrap items-center justify-center gap-6 text-xs ${isDark ? 'text-gray-400' : 'text-gray-500'
              }`}>
              <div className="flex items-center gap-2">
